const HomeColumn = (props)=>{
    return(
            <div className="three-columns-box column">
                ...
                <p className="three-columns-box-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Dignissimos explicabo iure repellat tempore voluptates voluptatum.</p>
            </div>
    )
}
