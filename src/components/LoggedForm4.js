            ...
            <div className="step-contact">
                ...
                <div className="step-date">
                    ...
                    <div className="step-line">
                        ...
                        <textarea rows="5" id="notes" name="notesForTheCourier"
                                  // value={formsData.notesForTheCourier}
                                  // onChange={handleChange}
                        />
                    </div>
                </div>
